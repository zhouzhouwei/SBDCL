% =========================================================================
%  The GSBL classification scheme proposed in
%
...
function [prediction, accuracy, err,testTime,Ztest] = classificationGSBL(Phi, W, test_data, labels, paras)
...
Ztest = SBLgroup(Phi,test_data, paras);
